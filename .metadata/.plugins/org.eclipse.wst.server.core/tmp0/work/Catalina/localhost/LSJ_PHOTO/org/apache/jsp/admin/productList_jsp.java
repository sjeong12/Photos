 ...
 * Generated at: 2016-12-11 07:59:47 UTC
...
return;
 ...
 request.setCharacterEncoding("utf-8"); 
      ...
      out.write("function add_product()\r\n");
      out.write("{\r\n");
      out.write("\tdocument.frm_s.action = \"/LSJ_PHOTO/home.jsp?page=/admin/addProduct\";\r\n");
      out.write("\tdocument.frm_s.submit();\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("\r\n");
    ...
    int pageSize = Integer.parseInt(strPageSize);     // paging    목록의 갯수 INT로 변경
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<FORM NAME = frm_s  ACTION=\"/LSJ_PHOTO/home.jsp?page=/admin/productList\" METHOD=post>\r\n");
      ...
      out.write("   </SELECT>\r\n");
      out.write("\r\n");
      out.write("<INPUT TYPE=button VALUE=\"새 상품 추가\" onclick = \"add_product()\">\r\n");
      out.write("<right>\r\n");
      ...
      out.write("\r\n");
      out.write("    \r\n");
      out.write("<TABLE border = \"0\" cellspacing = \"1\" cellpadding = \"5\" width = \"700\" >   \r\n");
...
if (in_search_key.equals("")){
   ...
   while(rs.next())    
   {
      ...
      out.write("      <a href=\"/LSJ_PHOTO/home.jsp?page=/admin/productView&pcode=");
      out.print( code );
      out.write("\">\r\n");
...
if (currentGrp > 1){    //  그룹 2부터는 이전 페이지 표시
      ...
      out.write("\r\n");
      out.write(" [<A href=\"/LSJ_PHOTO/home.jsp?page=/admin/productList&PageNum=");
