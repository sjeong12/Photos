 ...
 * Generated at: 2016-12-02 15:44:18 UTC
...
public final class boardDdelete_005fok_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try
{
	...
	while (rs.next()){
		...
		String filePath = getServletContext().getRealPath("/boardD/upfile") + File.separator + fileName1; 
		File f1 = new File(filePath);

		if (f1.exists()) new File(filePath).delete();

		filePath = getServletContext().getRealPath("/boardD/upfile")+ File.separator + fileName2; 
