...
{
	document.fview.action = "/LSJ_PHOTO/admin/productDelete_ok.jsp";
	document.fview.submit();
}

function submit_list()
{
	document.fview.action = "/LSJ_PHOTO/home.jsp?page=/admin/productList";
	document.fview.submit();
}
...
%>
		...
		<TABLE WIDTH = "600" BORDER = "1" CellPadding = "5" CellSpacing = "0">
			<TR>
				<TD bgcolor = "EAEAEA" WIDTH = "15%" ALIGN = "left"><font size = 2>제품코드</font></TD>
				<TD WIDTH = "85%" ALIGN = "left"><font size = 2><%= code %></font></TD>
			</TR>
			<TR>
			...
			<TR>
				<TD bgcolor = "EAEAEA" WIDTH = "15%" ALIGN = "left"><font size = 2>인기도</font></TD>
				<TD WIDTH = "85%" ALIGN = "left"><font size = 2><%= popular %></font></TD>
			</TR>
			<TR>
...
%>
			...
			<TR>
				<TD WIDTH = "100%" ALIGN = "center" colspan="2">
					<TEXTAREA NAME="contents" ROWS=5 COLS=60 disabled><%= info %></TEXTAREA>
				</TD>
			</TR>
			<TR>
				<TD WIDTH = "100%" ALIGN = "center" COLSPAN = "2">
